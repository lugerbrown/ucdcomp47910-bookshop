...
public class CustomerWebController {
    ...
    public CustomerWebController(CustomerRepository customerRepository, PasswordEncoder passwordEncoder, RegistrationValidationService registrationValidationService) {
